...
import com.ehire.entities.Event;
import com.ehire.entities.Reservation;
...
import com.ehire.services.eventService;
 ...
 * @author LENOVO
 */
public class AddEventPage extends Form {
    Label bienvenue;
   ...
   public AddEventPage(Resources res){
       ...
       confirm.addActionListener((e) -> {
          ...
          // System.err.println("selected date: " + datePicker.getDate().toString() + " w selected findate: " + datefinPicker.getDate().toString());
           ...
           rs.addEvent(r);
            ...
            s.setExpires(3000);
            s.setMessage("evennement ajouté avec succés!");

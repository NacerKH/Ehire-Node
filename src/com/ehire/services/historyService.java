...
import com.ehire.entities.History;
...
public ArrayList<History> reponses;
    ...
    public static historyService getInstance() {
        ...
        public boolean addReponses(History r) {
        String url = Statics.BASE_URL1 + "/fr/ws/addacceuille?" + "nomarchive=" + r.getNomarchive() + "&description=" + r.getDescription()+ "&image=" + r.getImage(); //création de l'URL
        ...
        public ArrayList<History> parseReponses(String jsonText){
        ...
        try {
            ...
            for(Map<String,Object> obj : list){
                ...
                f.setId((int)id);
//                float idarchive = Float.parseFloat(obj.get("idarchive").toString());
                f.setIdarchive(1);
               ...
               f.setNomarchive(obj.get("nomarchive").toString());
    ...
    public ArrayList<History> getAllReponses(){
        String url = Statics.BASE_URL1+"/fr/ws/acceuille";
        req.setUrl(url);
        req.setPost(false);
        req.addResponseListener(new ActionListener<NetworkEvent>() {
            @Override

...
public class Manage extends Form {
    ...
    private void addGUIs() {
        ...
        if (currentOffre == null) {
            ...
            titreTF.setText(currentOffre.getFullName());
            prixTF.setText(String.valueOf(currentOffre.getEmail()));
            descriptionTF.setText(currentOffre.getPhoneNumber());
    ...
    private void addActions() {
        ...
        if (currentOffre == null) {
            manageButton.addActionListener(action -> {
                if (controleDeSaisie()) {
                    int responseCode = candidatService.getInstance().add(
                            new candidat(
                                    titreTF.getText(),
            ...
            manageButton.addActionListener(action -> {
                if (controleDeSaisie()) {
                    int responseCode = candidatService.getInstance().edit(
                            new candidat(
